...
public class GroundJunctionTeleop extends CommandBase {
  ...
  public void execute() {
    ...
    if(!flag){
      ...
      if((RobotContainer.pivotTwo.get_second_pivot_encoder() <= (-70.0+5.0)&&RobotContainer.pivotTwo.get_second_pivot_encoder() >= (-70.0-5.0)) && (RobotContainer.pivotOne.get_first_pivot_encoder() >= (51.0-5.0)&&RobotContainer.pivotOne.get_first_pivot_encoder() <= (55.0+5.0))){
